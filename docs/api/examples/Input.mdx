...
who can move the object and not receieve the rendered position from the server via [`VoxelRenderer.receiveTransform = false`](VoxelRenderer#bool-receiveTransform)
